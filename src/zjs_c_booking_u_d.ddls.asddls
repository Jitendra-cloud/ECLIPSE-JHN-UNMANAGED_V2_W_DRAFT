...
define view entity ZJS_C_BOOKING_U_D
  as projection on ZJS_I_BOOKING_U_D
...
{ ///DMO/I_Booking_U
  ...
  key BookingID,
      ...
      { entity: {name: 'ZJS_I_Flight_StdVH', element: 'AirlineID'},
      ...
      @Consumption.valueHelpDefinition: [
      { entity: {name: 'ZJS_I_Flight_StdVH', element: 'ConnectionID'},
      additionalBinding: [ { localElement: 'FlightDate', element: 'FlightDate', usage: #RESULT},
      ...
      @Consumption.valueHelpDefinition: [
      { entity: {name: 'ZJS_I_Flight_StdVH', element: 'FlightDate'},
      ...
      @Consumption.valueHelpDefinition: [
      { entity: {name: 'ZJS_I_Flight_StdVH', element: 'Price'},
      ...
      /* Associations */
      ///DMO/I_Booking_U
      _Travel         : redirected to parent ZJS_C_TRAVEL_U_D,
      _BookSupplement : redirected to composition child ZJS_C_BOOKINGSUPPLEMENT_U_D,
      _Carrier,
      _Connection,
      _Customer
}
