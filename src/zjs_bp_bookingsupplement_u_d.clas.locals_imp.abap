...
**********************************************************************
  METHOD update.
    DATA: messages         TYPE zjs_tt_message,
          book_supplements TYPE zjs_book_suppl.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<bookingsupplement>).
      ...
      CALL FUNCTION 'ZJS_FLIGHT_TRAVEL_UPDATE'
        EXPORTING
          is_travel              = VALUE zjs_st_travel_in( travel_id = <bookingsupplement>-travelid )
          is_travelx             = VALUE zjs_st_travel_inx( travel_id = <bookingsupplement>-travelid )
          it_booking_supplement  = VALUE zjs_tt_booking_supplement_in( ( CORRESPONDING #( book_supplements ) ) )
          it_booking_supplementx = VALUE zjs_tt_booking_supplement_inx( (
    ...
    LOOP AT keys ASSIGNING FIELD-SYMBOL(<bookingsupplement>).
      ...
      CALL FUNCTION 'ZJS_FLIGHT_TRAVEL_UPDATE'
        EXPORTING
          is_travel              = VALUE zjs_st_travel_in( travel_id = <bookingsupplement>-travelid )
          is_travelx             = VALUE zjs_st_travel_inx( travel_id = <bookingsupplement>-travelid )
          it_booking             = VALUE zjs_tt_booking_in( ( booking_id = <bookingsupplement>-bookingid ) )
          it_bookingx            = VALUE zjs_tt_booking_inx( ( booking_id = <bookingsupplement>-bookingid ) )
          it_booking_supplement  = VALUE zjs_tt_booking_supplement_in( ( booking_supplement_id = <bookingsupplement>-bookingSupplementid
           booking_id = <bookingsupplement>-BookingID ) )
          it_booking_supplementx = VALUE zjs_tt_booking_supplement_inx( ( booking_supplement_id = <bookingsupplement>-bookingsupplementid
          booking_id = <bookingsupplement>-bookingid
...
**********************************************************************
  METHOD read.
    ...
    DATA: booksuppls_out TYPE zjs_tt_booking_supplement,
          messages       TYPE zjs_tt_message.
...
**********************************************************************
  METHOD rba_Booking.
    DATA: booking_out TYPE zjs_tt_booking,
